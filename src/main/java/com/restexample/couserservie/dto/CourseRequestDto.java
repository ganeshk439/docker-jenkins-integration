...
public class CourseRequestDto {
	...
	public CourseRequestDto(int courseId, String courseName, String trainerName, String duration, Date startDate,
	...
	public String toString() {
		return "CourseRequestDto [courseId=" + courseId + ", courseName=" + courseName + ", trainerName=" + trainerName
